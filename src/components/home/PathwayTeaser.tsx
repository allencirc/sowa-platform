  ...
  return (
    <section className="relative py-20 sm:py-24 overflow-hidden bg-gradient-to-br from-primary via-primary to-primary-light text-text-inverse">
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        ...
        <svg className="absolute right-0 top-1/2 -translate-y-1/2 w-[600px] h-[300px] opacity-10 hidden lg:block" viewBox="0 0 600 300">
          ...
          <line x1="124" y1="80" x2="256" y2="150" stroke="white" strokeWidth="1.5" strokeDasharray="6 4" />
          <line x1="304" y1="150" x2="436" y2="100" stroke="white" strokeWidth="1.5" />
          <line x1="280" y1="174" x2="380" y2="216" stroke="white" strokeWidth="1.5" strokeDasharray="6 4" />
        </svg>
      </div>
      ...
      <Container className="relative">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-lg text-white/70 mb-8 leading-relaxed">
            Explore an interactive map showing how careers connect across the
            offshore wind sector — from entry-level roles to senior leadership.
          </p>
