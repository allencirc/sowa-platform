...
import { Calendar, Clock, MapPin, Monitor, Globe, Users } from "lucide-react";
      ...
      <section className="bg-surface py-10 sm:py-14">
        <Container>
          <div className="max-w-3xl">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold text-text-primary mb-6">{event.title}</h1>
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-4 sm:gap-6 text-text-secondary">
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium">{formatEventDateTime(event.startDate)}</span>
              </div>
              ...
              {event.capacity && (
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    ...
                    {isFull && <span className="ml-1 text-status-error font-medium">(Full)</span>}
                  </span>
                </div>
              )}
            </div>
          ...
          <div className="max-w-3xl space-y-10">
            ...
            {!isFull ? (
              ...
              <div className="bg-gradient-to-r from-gray-600 to-gray-700 rounded-xl p-6 sm:p-8 text-center">
                <h3 className="text-xl font-bold text-white mb-2">This event is fully booked</h3>
